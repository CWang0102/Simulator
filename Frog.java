...
public class Frog extends Prey
{
     ...
     * @param newTadpoles A list to return newly born Tadpoles.
     */
    public void act(List<LifeForms> newTadpoles)
    {
       incrementAge();
       if(isAlive()) {
            giveBirth(newTadpoles);            
     ...
     * @param newTadpoles A list to return newly born tadpoles.
     */
    private void giveBirth(List<LifeForms> newTadpoles)
    {
